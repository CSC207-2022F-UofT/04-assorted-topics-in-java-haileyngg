...
public class Trader<T> {
     ...
     */
    /**
     * If object is Tradable, get the object's price. Otherwise, indicate missing price.
     * @param object
     * @return the object's price if it is Tradable, otherwise return Tradable.MISSING_PRICE.
     */
